...
class UpdateCartRequest(object):
    ...
    def affiliate(self):
        """
        Gets the affiliate of this UpdateCartRequest.
        Language ID to use in Cart

        :return: The affiliate of this UpdateCartRequest.
        :rtype: int
        """
    ...
    def affiliate(self, affiliate):
        """
        Sets the affiliate of this UpdateCartRequest.
        Language ID to use in Cart

        :param affiliate: The affiliate of this UpdateCartRequest.
        :type: int
        """
