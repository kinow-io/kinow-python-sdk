...
class FreeGift1(object):
    ...
    """
    def __init__(self, id_product=None, id_product_attribute=None, id_customer=None, firstname=None, lastname=None, email=None):
        """
    ...
    def id_product_attribute(self):
        """
        Gets the id_product_attribute of this FreeGift1.
        Product ID attribute to offer

        :return: The id_product_attribute of this FreeGift1.
        :rtype: int
        """
    ...
    def id_product_attribute(self, id_product_attribute):
        """
        Sets the id_product_attribute of this FreeGift1.
        Product ID attribute to offer

        :param id_product_attribute: The id_product_attribute of this FreeGift1.
        :type: int
        """
        if id_product_attribute is None:
            raise ValueError("Invalid value for `id_product_attribute`, must not be `None`")
