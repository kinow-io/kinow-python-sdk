...
class Actor(object):
    ...
    """
    def __init__(self, id=None, name=None, date_add=None, date_upd=None, active=None, link_rewrite=None, description=None, image=None, description_short=None, meta_description=None, meta_keywords=None, meta_title=None):
        """
