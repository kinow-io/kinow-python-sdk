...
class CreateCustomerRequest(object):
    ...
    """
    def __init__(self, firstname=None, lastname=None, email=None, password=None, id_gender=None, birthday=None, newsletter=None, optin=None, active=None, id_lang=None, id_country=None, id_state=None, city=None, postcode=None, address1=None, company=None, send_mail=None):
        """
