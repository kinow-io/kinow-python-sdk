...
class WidgetHomeRail(object):
    ...
    """
    def __init__(self, id=None, label=None, type=None, type_id=None, visibility=None, position=None, video_focus=None):
        """
    ...
    def video_focus(self):
        """
        Gets the video_focus of this WidgetHomeRail.

        :return: The video_focus of this WidgetHomeRail.
        :rtype: int
        """
        return self._video_focus

    @video_focus.setter
    def video_focus(self, video_focus):
        """
        Sets the video_focus of this WidgetHomeRail.

        :param video_focus: The video_focus of this WidgetHomeRail.
        :type: int
        """
