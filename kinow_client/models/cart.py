...
class Cart(object):
    ...
    """
    def __init__(self, id=None, id_currency=None, id_customer=None, id_lang=None, date_add=None, date_upd=None, total=None, products=None, cart_rules=None, total_without_tax=None, total_trial=None):
        """
