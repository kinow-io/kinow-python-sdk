...
class CreateVideoRequest(object):
    ...
    """
    def __init__(self, id_product=None, id_video_group=None, id_product_image=None, id_language=None, language_filter=None, id_media_source=None, name=None, description=None, description_short=None, duration=None, filename=None, position=None, subscription=None, free=None, download=None, active=None, date_add=None, date_upd=None, can_watch=None, cover=None, thumbnail=None, geoloc_enabled=None, behavior_detected_countries=None, behavior_non_detected_countries=None, has_free_access=None, advertising_url=None):
        """
    ...
    def description_short(self):
        """
        Gets the description_short of this CreateVideoRequest.

        :return: The description_short of this CreateVideoRequest.
        :rtype: list[I18nField]
        """
    ...
    def description_short(self, description_short):
        """
        Sets the description_short of this CreateVideoRequest.

        :param description_short: The description_short of this CreateVideoRequest.
        :type: list[I18nField]
        """
