...
class ProductAttributeCreateRequest(object):
    ...
    """
    def __init__(self, product_id=None, video__group_id=None, video_id=None, mode=None, type=None, quality=None, price=None, price_mode=None, duration=None, watching_duration=None):
        """
        ...
        self.attribute_map = {
            ...
            'video__group_id': 'video__group_id',
            'video_id': 'video_id',
            'mode': 'mode',
            'type': 'type',
            'quality': 'quality',
        ...
        self._video__group_id = video__group_id
    ...
    @property
    def video__group_id(self):
        """
        Gets the video__group_id of this ProductAttributeCreateRequest.
        Video Group ID to restrict this access

        :return: The video__group_id of this ProductAttributeCreateRequest.
        :rtype: int
        """
        return self._video__group_id

    @video__group_id.setter
    def video__group_id(self, video__group_id):
        """
        Sets the video__group_id of this ProductAttributeCreateRequest.
        Video Group ID to restrict this access

        :param video__group_id: The video__group_id of this ProductAttributeCreateRequest.
        :type: int
        """
