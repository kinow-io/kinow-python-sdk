...
class ProductAttributeCreateRequest(object):
    ...
    def video_group_id(self):
        """
        Gets the video_group_id of this ProductAttributeCreateRequest.
        Video Group ID to restrict this access

        :return: The video_group_id of this ProductAttributeCreateRequest.
        :rtype: int
        """
    ...
    def video_group_id(self, video_group_id):
        """
        Sets the video_group_id of this ProductAttributeCreateRequest.
        Video Group ID to restrict this access

        :param video_group_id: The video_group_id of this ProductAttributeCreateRequest.
        :type: int
        """
    ...
    def maximum_views(self):
        """
        Gets the maximum_views of this ProductAttributeCreateRequest.
        Maximum views a user can watch video

        :return: The maximum_views of this ProductAttributeCreateRequest.
        :rtype: float
        """
    ...
    def maximum_views(self, maximum_views):
        """
        Sets the maximum_views of this ProductAttributeCreateRequest.
        Maximum views a user can watch video

        :param maximum_views: The maximum_views of this ProductAttributeCreateRequest.
        :type: float
        """
