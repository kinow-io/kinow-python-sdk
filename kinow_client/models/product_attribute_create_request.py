...
class ProductAttributeCreateRequest(object):
    ...
    """
    def __init__(self, product_id=None, video_group_id=None, video_id=None, type=None, mode=None, quality=None, price=None, price_mode=None, duration=None, watching_duration=None):
        """
