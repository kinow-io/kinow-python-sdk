...
class CartPrice(object):
    ...
    """
    def __init__(self, cart_id=None, total_without_tax=None, total_tax=None, total_discount=None, total_trial=None, total=None, total_without_tax_formatted=None, total_tax_formatted=None, total_discount_formatted=None, total_trial_formatted=None, total_formatted=None, taxes=None, cart_rules=None):
        """
    ...
    def cart_rules(self):
        """
        Gets the cart_rules of this CartPrice.

        :return: The cart_rules of this CartPrice.
        :rtype: list[CartRulePrice]
        """
    ...
    def cart_rules(self, cart_rules):
        """
        Sets the cart_rules of this CartPrice.

        :param cart_rules: The cart_rules of this CartPrice.
        :type: list[CartRulePrice]
        """
