...
class Gift(object):
    ...
    """
    def __init__(self, id=None, id_cart=None, id_product=None, id_product_attribute=None, firstname=None, lastname=None, message=None, email=None, used=None, date_send=None):
        """
