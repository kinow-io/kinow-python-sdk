...
class PlaylistResponse(object):
    ...
    def __init__(self, id=None, name=None, id_customer=None):
        """
        PlaylistResponse - a model defined in Swagger
    ...
    def id_customer(self):
        """
        Gets the id_customer of this PlaylistResponse.

        :return: The id_customer of this PlaylistResponse.
        :rtype: int
        """
    ...
    def id_customer(self, id_customer):
        """
        Sets the id_customer of this PlaylistResponse.

        :param id_customer: The id_customer of this PlaylistResponse.
        :type: int
        """
