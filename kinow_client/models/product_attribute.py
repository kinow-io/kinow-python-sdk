...
class ProductAttribute(object):
    ...
    """
    def __init__(self, id=None, video_group_id=None, video_id=None, name=None, price=None, price_mode=None, price_without_reduction=None, mode=None, type=None, quality=None, duration=None, watching_duration=None, active=None):
        """
