...
class TasksApi(object):
    ...
    def create_task(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_task(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param TaskCreateRequest body: Create task object (required)
        :return: Task
    ...
    def create_task_with_http_info(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_task_with_http_info(body, callback=callback_function)
