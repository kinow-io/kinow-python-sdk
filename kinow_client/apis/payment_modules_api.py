...
class PaymentModulesApi(object):
    ...
    def get_payment_methods(self, customer_id, payment_name, **kwargs):
        ...
        :return: list[PaymentMethodsResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_payment_methods_with_http_info(self, customer_id, payment_name, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[PaymentMethodsResponse]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_payment_modules(self, **kwargs):
        ...
        :param int page:
        :param int per_page:
        :return: PaymentModuleListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_payment_modules_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentModuleListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_payment_token(self, token, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_payment_token(token, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int token: Token to fetch (required)
        :return: PaymentToken1
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_payment_token_with_http_info(token, **kwargs)
        else:
            (data) = self.get_payment_token_with_http_info(token, **kwargs)
            return data

    def get_payment_token_with_http_info(self, token, **kwargs):
        """
        Get payment token details
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_payment_token_with_http_info(token, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_payment_token" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'token' is set
        if ('token' not in params) or (params['token'] is None):
            raise ValueError("Missing the required parameter `token` when calling `get_payment_token`")


        collection_formats = {}

        resource_path = '/payment-modules/token/{token}'.replace('{format}', 'json')
        path_params = {}
        if 'token' in params:
    ...
    def get_pending_payments(self, payment_name, customer_id, **kwargs):
        ...
        :param str payment_name: (required)
        :param int customer_id: (required)
        :return: list[PaymentDetailsResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_pending_payments_with_http_info(self, payment_name, customer_id, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[PaymentDetailsResponse]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_pending_payments_with_ip_with_http_info(self, payment_name, customer_id, ip_address, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentDetailsListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
