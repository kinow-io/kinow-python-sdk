...
class ExtractsApi(object):
    ...
    def create_subtitle(self, extract_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subtitle(extract_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_subtitle_with_http_info(extract_id, body, **kwargs)
        else:
            (data) = self.create_subtitle_with_http_info(extract_id, body, **kwargs)
            return data

    def create_subtitle_with_http_info(self, extract_id, body, **kwargs):
        """
        Create new Extract Subtitle
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subtitle_with_http_info(extract_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_subtitle" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'extract_id' is set
        if ('extract_id' not in params) or (params['extract_id'] is None):
            raise ValueError("Missing the required parameter `extract_id` when calling `create_subtitle`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_subtitle`")
        ...
        query_params = {}
        if 'extract_id' in params:
            query_params['extract_id'] = params['extract_id']
    ...
    def get_extract_player_with_http_info(self, extract_id, **kwargs):
        ...
        all_params = ['extract_id', 'ip_address']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
