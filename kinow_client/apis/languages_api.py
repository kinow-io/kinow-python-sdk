...
class LanguagesApi(object):
    ...
    def get_languages(self, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.get_languages_with_http_info(**kwargs)
        else:
            (data) = self.get_languages_with_http_info(**kwargs)
            return data

    def get_languages_with_http_info(self, **kwargs):
        """
        Get language list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_languages_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='LanguageListResponse',
