...
class BookmarksApi(object):
    ...
    def attach_bookmark_to_customer_with_http_info(self, customer_id, product_id, **kwargs):
        ...
        all_params = ['customer_id', 'product_id', 'playlist_id']
        ...
        if 'playlist_id' in params:
            form_params.append(('playlist_id', params['playlist_id']))
    ...
    def get_customer_bookmarks_with_http_info(self, customer_id, **kwargs):
        ...
        all_params = ['customer_id', 'playlist_id', 'page', 'per_page', 'sort_by', 'sort_direction']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = {}
        if 'playlist_id' in params:
            query_params['playlist_id'] = params['playlist_id']
        if 'page' in params:
