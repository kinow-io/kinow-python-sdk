...
class CategoriesApi(object):
    ...
    def get_category_actors_with_http_info(self, category_id, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='CategoryActorsResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def upload_category_cover(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_category_cover(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UploadCategoryCoverRequest body: (required)
        :return: ImageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_category_cover_with_http_info(body, **kwargs)
        else:
            (data) = self.upload_category_cover_with_http_info(body, **kwargs)
            return data

    def upload_category_cover_with_http_info(self, body, **kwargs):
        """
        Upload Category cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_category_cover_with_http_info(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_category_cover`")
