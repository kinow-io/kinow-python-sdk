...
class CountriesApi(object):
    ...
    def get_countries(self, **kwargs):
        ...
        :param int page:
        :param int per_page:
        :param bool bypass_pagination: Use or skip pagination
    ...
    def get_countries_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='CountryListResponse',
    ...
    def get_states(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_states(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_states_with_http_info(**kwargs)
        else:
            (data) = self.get_states_with_http_info(**kwargs)
            return data

    def get_states_with_http_info(self, **kwargs):
        """
        Get states list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_states_with_http_info(callback=callback_function)
        ...
        resource_path = '/countries/states'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='StateListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
