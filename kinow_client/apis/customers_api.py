...
class CustomersApi(object):
    ...
    def get_customer_has_access_to_videos(self, customer_id, ip_address, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_customer_has_access_to_videos(customer_id, ip_address, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_customer_has_access_to_videos_with_http_info(customer_id, ip_address, body, **kwargs)
        else:
            (data) = self.get_customer_has_access_to_videos_with_http_info(customer_id, ip_address, body, **kwargs)
            return data

    def get_customer_has_access_to_videos_with_http_info(self, customer_id, ip_address, body, **kwargs):
        """
        Get customer access to Videos
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_customer_has_access_to_videos_with_http_info(customer_id, ip_address, body, callback=callback_function)
        ...
        # verify the required parameter 'ip_address' is set
        if ('ip_address' not in params) or (params['ip_address'] is None):
            raise ValueError("Missing the required parameter `ip_address` when calling `get_customer_has_access_to_videos`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
