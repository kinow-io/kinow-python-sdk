...
class FreeGiftsApi(object):
    ...
    def create_free_gift(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param FreeGift1 body: Free Gift settings (required)
        :return: FreeGift
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_free_gift(self, free_gift_id, body, **kwargs):
        """
        Update free Gift
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_free_gift(free_gift_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int free_gift_id: Free Gift ID to fetch (required)
        :param Gift1 body: Free Gift settings (required)
        :return: FreeGift
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_free_gift_with_http_info(free_gift_id, body, **kwargs)
        else:
            (data) = self.update_free_gift_with_http_info(free_gift_id, body, **kwargs)
            return data

    def update_free_gift_with_http_info(self, free_gift_id, body, **kwargs):
        """
        Update free Gift
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_free_gift_with_http_info(free_gift_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_free_gift" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'free_gift_id' is set
        if ('free_gift_id' not in params) or (params['free_gift_id'] is None):
            raise ValueError("Missing the required parameter `free_gift_id` when calling `update_free_gift`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_free_gift`")
