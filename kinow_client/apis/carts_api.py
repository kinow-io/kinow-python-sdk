...
class CartsApi(object):
    ...
    def add_product_to_cart(self, cart_id, body, **kwargs):
        """
        Add product to cart
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_product_to_cart(cart_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int cart_id: Cart ID to fetch (required)
        :param AddProductToCartRequest body: Add product to cart request (required)
        :return: CartResponse
        ...
        if kwargs.get('callback'):
            return self.add_product_to_cart_with_http_info(cart_id, body, **kwargs)
        else:
            (data) = self.add_product_to_cart_with_http_info(cart_id, body, **kwargs)
            return data

    def add_product_to_cart_with_http_info(self, cart_id, body, **kwargs):
        """
        Add product to cart
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_product_to_cart_with_http_info(cart_id, body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_product_to_cart`")
    ...
    def create_cart(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CreateCartRequest body: Cart settings (required)
        :return: CartResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_cart_payment_modules(self, cart_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cart_payment_modules(cart_id, callback=callback_function)
        ...
        :param int page:
        :param int per_page:
        :return: PaymentModuleListResponse1
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_cart_payment_modules_with_http_info(cart_id, **kwargs)
        else:
            (data) = self.get_cart_payment_modules_with_http_info(cart_id, **kwargs)
            return data

    def get_cart_payment_modules_with_http_info(self, cart_id, **kwargs):
        """
        Get payment gateways list available for given cart
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cart_payment_modules_with_http_info(cart_id, callback=callback_function)
        ...
        all_params = ['cart_id', 'page', 'per_page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cart_payment_modules" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cart_id' is set
        if ('cart_id' not in params) or (params['cart_id'] is None):
            raise ValueError("Missing the required parameter `cart_id` when calling `get_cart_payment_modules`")


        collection_formats = {}

        resource_path = '/carts/{cart_id}/payments'.replace('{format}', 'json')
        path_params = {}
        if 'cart_id' in params:
            path_params['cart_id'] = params['cart_id']
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentModuleListResponse1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_carts_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='CartListResponse1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_payment_url_with_http_info(self, cart_id, payment_name, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentUrlResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def prepare_payment_with_http_info(self, cart_id, payment_name, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='PaymentDetailsResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def remove_product_from_cart(self, cart_id, product_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_product_from_cart(cart_id, product_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.remove_product_from_cart_with_http_info(cart_id, product_id, **kwargs)
        else:
            (data) = self.remove_product_from_cart_with_http_info(cart_id, product_id, **kwargs)
            return data

    def remove_product_from_cart_with_http_info(self, cart_id, product_id, **kwargs):
        """
        Remove product from cart
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_product_from_cart_with_http_info(cart_id, product_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method remove_product_from_cart" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cart_id' is set
        if ('cart_id' not in params) or (params['cart_id'] is None):
            raise ValueError("Missing the required parameter `cart_id` when calling `remove_product_from_cart`")
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `remove_product_from_cart`")
    ...
    def update_cart(self, cart_id, body, **kwargs):
        ...
        :param UpdateCartRequest body: Cart settings (required)
        :return: CartResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def validate_payment(self, cart_id, payment_name, payment_argument, **kwargs):
        ...
        :param int cart_id: Cart ID to fetch (required)
        :param str payment_name: Payment gateway name (required)
        :param PaymentArgumentsResponse payment_argument: Payment argument (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
