...
class CartsApi(object):
    ...
    def add_product_to_cart(self, cart_id, product_id, ip_address, **kwargs):
        """
        Add product to cart
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_product_to_cart(cart_id, product_id, ip_address, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.add_product_to_cart_with_http_info(cart_id, product_id, ip_address, **kwargs)
        else:
            (data) = self.add_product_to_cart_with_http_info(cart_id, product_id, ip_address, **kwargs)
            return data

    def add_product_to_cart_with_http_info(self, cart_id, product_id, ip_address, **kwargs):
        """
        Add product to cart
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_product_to_cart_with_http_info(cart_id, product_id, ip_address, callback=callback_function)
        ...
        all_params = ['cart_id', 'product_id', 'ip_address', 'product_attribute_id', 'switch_subscription_id', 'is_gift']
        ...
        if ('ip_address' not in params) or (params['ip_address'] is None):
            raise ValueError("Missing the required parameter `ip_address` when calling `add_product_to_cart`")
