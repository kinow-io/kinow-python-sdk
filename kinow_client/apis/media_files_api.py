...
class MediaFilesApi(object):
    ...
    def convert_live_to_vod(self, source_id, body, **kwargs):
        """
        Convert Live to VOD
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.convert_live_to_vod(source_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int source_id: Media source ID to fetch (required)
        :param ConvertMediaLiveRequest body: Convert MediaLive object (required)
        :return: None
        ...
        if kwargs.get('callback'):
            return self.convert_live_to_vod_with_http_info(source_id, body, **kwargs)
        else:
            (data) = self.convert_live_to_vod_with_http_info(source_id, body, **kwargs)
            return data

    def convert_live_to_vod_with_http_info(self, source_id, body, **kwargs):
        """
        Convert Live to VOD
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.convert_live_to_vod_with_http_info(source_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method convert_live_to_vod" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source_id' is set
        if ('source_id' not in params) or (params['source_id'] is None):
            raise ValueError("Missing the required parameter `source_id` when calling `convert_live_to_vod`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `convert_live_to_vod`")


        collection_formats = {}

        resource_path = '/media-sources/{source_id}/live2vod'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_live(self, source_id, body, **kwargs):
        """
        Create a live
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_live(source_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int source_id: Media source ID to fetch (required)
        :param CreateMediaLiveRequest body: Create MediaFile object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_live_with_http_info(source_id, body, **kwargs)
        else:
            (data) = self.create_live_with_http_info(source_id, body, **kwargs)
            return data

    def create_live_with_http_info(self, source_id, body, **kwargs):
        """
        Create a live
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_live_with_http_info(source_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_live" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source_id' is set
        if ('source_id' not in params) or (params['source_id'] is None):
            raise ValueError("Missing the required parameter `source_id` when calling `create_live`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_live`")


        collection_formats = {}

        resource_path = '/media-sources/{source_id}/live'.replace('{format}', 'json')
        path_params = {}
        if 'source_id' in params:
            path_params['source_id'] = params['source_id']
    ...
    def get_live_streams(self, media_file_id, **kwargs):
        """
        Get live streams
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_live_streams(media_file_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int media_file_id: Media file ID to fetch (required)
        :return: MediaFileStreamListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_live_streams_with_http_info(media_file_id, **kwargs)
        else:
            (data) = self.get_live_streams_with_http_info(media_file_id, **kwargs)
            return data

    def get_live_streams_with_http_info(self, media_file_id, **kwargs):
        """
        Get live streams
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_live_streams_with_http_info(media_file_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_live_streams" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'media_file_id' is set
        if ('media_file_id' not in params) or (params['media_file_id'] is None):
            raise ValueError("Missing the required parameter `media_file_id` when calling `get_live_streams`")


        collection_formats = {}

        resource_path = '/media-files/{media_file_id}/streams'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='MediaFileStreamListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
