...
class PrepaymentsApi(object):
    ...
    def get_prepayment_balances(self, customer_id, type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_balances(customer_id, type, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int customer_id: Customer ID to fetch (required)
        :param str type: PrepaymentBalance type to fetch (currency or credit) (required)
        ...
        if kwargs.get('callback'):
            return self.get_prepayment_balances_with_http_info(customer_id, type, **kwargs)
        else:
            (data) = self.get_prepayment_balances_with_http_info(customer_id, type, **kwargs)
            return data

    def get_prepayment_balances_with_http_info(self, customer_id, type, **kwargs):
        """
        Get PrepaymentBalances list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_balances_with_http_info(customer_id, type, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_prepayment_balances" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'customer_id' is set
        if ('customer_id' not in params) or (params['customer_id'] is None):
            raise ValueError("Missing the required parameter `customer_id` when calling `get_prepayment_balances`")
        # verify the required parameter 'type' is set
        if ('type' not in params) or (params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `get_prepayment_balances`")


        collection_formats = {}

        resource_path = '/customers/{customer_id}/prepayment-balance/{type}'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='PrepaymentBalance',
    ...
    def get_prepayment_bonus(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_bonus(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_prepayment_bonus_with_http_info(**kwargs)
        else:
            (data) = self.get_prepayment_bonus_with_http_info(**kwargs)
            return data

    def get_prepayment_bonus_with_http_info(self, **kwargs):
        """
        Get PrepaymentBonus list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_bonus_with_http_info(callback=callback_function)
    ...
    def get_prepayment_bonus_0(self, prepayment_bonus_id, **kwargs):
        """
        Get PrepaymentBonus
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_bonus_0(prepayment_bonus_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_prepayment_bonus_0_with_http_info(prepayment_bonus_id, **kwargs)
        else:
            (data) = self.get_prepayment_bonus_0_with_http_info(prepayment_bonus_id, **kwargs)
            return data

    def get_prepayment_bonus_0_with_http_info(self, prepayment_bonus_id, **kwargs):
        """
        Get PrepaymentBonus
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_bonus_0_with_http_info(prepayment_bonus_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_prepayment_bonus_0" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('prepayment_bonus_id' not in params) or (params['prepayment_bonus_id'] is None):
            raise ValueError("Missing the required parameter `prepayment_bonus_id` when calling `get_prepayment_bonus_0`")
    ...
    def get_prepayment_operations(self, customer_id, type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_operations(customer_id, type, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int customer_id: Customer ID to fetch (required)
        :param str type: PrepaymentOperation type to fetch (currency or credit) (required)
        :param int page:
        :param int per_page:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_prepayment_operations_with_http_info(customer_id, type, **kwargs)
        else:
            (data) = self.get_prepayment_operations_with_http_info(customer_id, type, **kwargs)
            return data

    def get_prepayment_operations_with_http_info(self, customer_id, type, **kwargs):
        """
        Get PrepaymentOperations list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_operations_with_http_info(customer_id, type, callback=callback_function)
        ...
        # verify the required parameter 'customer_id' is set
        if ('customer_id' not in params) or (params['customer_id'] is None):
            raise ValueError("Missing the required parameter `customer_id` when calling `get_prepayment_operations`")
        # verify the required parameter 'type' is set
        if ('type' not in params) or (params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `get_prepayment_operations`")


        collection_formats = {}

        resource_path = '/customers/{customer_id}/prepayment-operation/{type}'.replace('{format}', 'json')
        path_params = {}
        if 'customer_id' in params:
            path_params['customer_id'] = params['customer_id']
        if 'type' in params:
