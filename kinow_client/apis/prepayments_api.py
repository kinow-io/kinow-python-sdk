...
class PrepaymentsApi(object):
    ...
    def get_prepayment_balances(self, customer_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_balances(customer_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_prepayment_balances_with_http_info(customer_id, **kwargs)
        else:
            (data) = self.get_prepayment_balances_with_http_info(customer_id, **kwargs)
            return data

    def get_prepayment_balances_with_http_info(self, customer_id, **kwargs):
        """
        Get PrepaymentBalances list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_prepayment_balances_with_http_info(customer_id, callback=callback_function)
