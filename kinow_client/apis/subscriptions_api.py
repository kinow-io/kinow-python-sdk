...
class SubscriptionsApi(object):
    ...
    def upload_subscription_cover(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_subscription_cover(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UploadSubscriptionCoverRequest body: (required)
        :return: ImageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_subscription_cover_with_http_info(body, **kwargs)
        else:
            (data) = self.upload_subscription_cover_with_http_info(body, **kwargs)
            return data

    def upload_subscription_cover_with_http_info(self, body, **kwargs):
        """
        Upload subscription cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_subscription_cover_with_http_info(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_subscription_cover`")
