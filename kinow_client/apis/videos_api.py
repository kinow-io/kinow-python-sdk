...
class VideosApi(object):
    ...
    def create_subtitle(self, video_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subtitle(video_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_subtitle_with_http_info(video_id, body, **kwargs)
        else:
            (data) = self.create_subtitle_with_http_info(video_id, body, **kwargs)
            return data

    def create_subtitle_with_http_info(self, video_id, body, **kwargs):
        """
        Create new Video Subtitle
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subtitle_with_http_info(video_id, body, callback=callback_function)
        ...
        # verify the required parameter 'video_id' is set
        if ('video_id' not in params) or (params['video_id'] is None):
            raise ValueError("Missing the required parameter `video_id` when calling `create_subtitle`")
