...
class VideosApi(object):
    ...
    def create_video(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CreateVideoRequest body: Video parameters (required)
    ...
    def get_video_player(self, video_id, **kwargs):
        ...
        :param bool force_reload: Force seekbar to the begining and ignore viewing resume
    ...
    def get_video_player_with_http_info(self, video_id, **kwargs):
        ...
        all_params = ['video_id', 'customer_id', 'country_id', 'ip_address', 'iso_code', 'force_reload']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'force_reload' in params:
            query_params['force_reload'] = params['force_reload']
    ...
    def get_videos_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='VideoListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_video(self, video_id, body, **kwargs):
        ...
        :param UpdateVideoRequest body:  (required)
        :return: VideoResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
