...
class ProductsApi(object):
    ...
    def detach_product_from_actor(self, product_id, actor_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_actor(product_id, actor_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.detach_product_from_actor_with_http_info(product_id, actor_id, **kwargs)
        else:
            (data) = self.detach_product_from_actor_with_http_info(product_id, actor_id, **kwargs)
            return data

    def detach_product_from_actor_with_http_info(self, product_id, actor_id, **kwargs):
        """
        Detach product from actor
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_actor_with_http_info(product_id, actor_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detach_product_from_actor" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `detach_product_from_actor`")
        # verify the required parameter 'actor_id' is set
        if ('actor_id' not in params) or (params['actor_id'] is None):
            raise ValueError("Missing the required parameter `actor_id` when calling `detach_product_from_actor`")
    ...
    def detach_product_from_director(self, product_id, director_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_director(product_id, director_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.detach_product_from_director_with_http_info(product_id, director_id, **kwargs)
        else:
            (data) = self.detach_product_from_director_with_http_info(product_id, director_id, **kwargs)
            return data

    def detach_product_from_director_with_http_info(self, product_id, director_id, **kwargs):
        """
        Detach product from director
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_director_with_http_info(product_id, director_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detach_product_from_director" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `detach_product_from_director`")
        # verify the required parameter 'director_id' is set
        if ('director_id' not in params) or (params['director_id'] is None):
            raise ValueError("Missing the required parameter `director_id` when calling `detach_product_from_director`")
