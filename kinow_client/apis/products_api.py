...
class ProductsApi(object):
    ...
    def get_customer_has_access_to_products(self, customer_id, ip_address, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_customer_has_access_to_products(customer_id, ip_address, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_customer_has_access_to_products_with_http_info(customer_id, ip_address, body, **kwargs)
        else:
            (data) = self.get_customer_has_access_to_products_with_http_info(customer_id, ip_address, body, **kwargs)
            return data

    def get_customer_has_access_to_products_with_http_info(self, customer_id, ip_address, body, **kwargs):
        """
        Get customer access to Products
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_customer_has_access_to_products_with_http_info(customer_id, ip_address, body, callback=callback_function)
        ...
        all_params = ['customer_id', 'ip_address', 'body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('ip_address' not in params) or (params['ip_address'] is None):
            raise ValueError("Missing the required parameter `ip_address` when calling `get_customer_has_access_to_products`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
