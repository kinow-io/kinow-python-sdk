...
class ProductsApi(object):
    ...
    def create_product(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CreateProductRequest body: Product parameters (required)
    ...
    def detach_director_from_product(self, product_id, director_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_director_from_product(product_id, director_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.detach_director_from_product_with_http_info(product_id, director_id, **kwargs)
        else:
            (data) = self.detach_director_from_product_with_http_info(product_id, director_id, **kwargs)
            return data

    def detach_director_from_product_with_http_info(self, product_id, director_id, **kwargs):
        """
        Detach director from product
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_director_from_product_with_http_info(product_id, director_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detach_director_from_product" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `detach_director_from_product`")
        # verify the required parameter 'director_id' is set
        if ('director_id' not in params) or (params['director_id'] is None):
            raise ValueError("Missing the required parameter `director_id` when calling `detach_director_from_product`")


        collection_formats = {}

        resource_path = '/products/{product_id}/directors/{director_id}'.replace('{format}', 'json')
        path_params = {}
        if 'product_id' in params:
            path_params['product_id'] = params['product_id']
        if 'director_id' in params:
    ...
    def get_product_attributes_with_http_info(self, product_id, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ProductAttributeListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_videos_from_product_with_http_info(self, product_id, **kwargs):
        ...
        all_params = ['product_id', 'page', 'per_page', 'sort_by', 'sort_direction', 'ip', 'filters']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ProductVideoListResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_product(self, product_id, body, **kwargs):
        ...
        :param UpdateProductRequest body: Update product request (required)
        :return: ProductResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
