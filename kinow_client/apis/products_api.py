...
class ProductsApi(object):
    ...
    def get_price_with_http_info(self, body, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[CartPriceResponse]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def upload_product_cover(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_product_cover(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UploadProductCoverRequest body: (required)
        :return: ImageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_product_cover_with_http_info(body, **kwargs)
        else:
            (data) = self.upload_product_cover_with_http_info(body, **kwargs)
            return data

    def upload_product_cover_with_http_info(self, body, **kwargs):
        """
        Upload product cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_product_cover_with_http_info(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_product_cover`")
