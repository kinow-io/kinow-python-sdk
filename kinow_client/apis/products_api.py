...
class ProductsApi(object):
    ...
    def associate_products(self, product_id, associated_product_ids, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.associate_products(product_id, associated_product_ids, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int product_id: Product ID to fetch (required)
        :param str associated_product_ids: Products IDs to associate to another product. IDs must be separated with comma (,) (required)
        :return: None
        ...
        if kwargs.get('callback'):
            return self.associate_products_with_http_info(product_id, associated_product_ids, **kwargs)
        else:
            (data) = self.associate_products_with_http_info(product_id, associated_product_ids, **kwargs)
            return data

    def associate_products_with_http_info(self, product_id, associated_product_ids, **kwargs):
        """
        Associate products to another product
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.associate_products_with_http_info(product_id, associated_product_ids, callback=callback_function)
        ...
        all_params = ['product_id', 'associated_product_ids']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method associate_products" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `associate_products`")
        # verify the required parameter 'associated_product_ids' is set
        if ('associated_product_ids' not in params) or (params['associated_product_ids'] is None):
            raise ValueError("Missing the required parameter `associated_product_ids` when calling `associate_products`")
        ...
        form_params = []
        local_var_files = {}
        if 'associated_product_ids' in params:
            form_params.append(('associated_product_ids', params['associated_product_ids']))
    ...
    def attach_product_to_actor(self, product_id, actor_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_actor(product_id, actor_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.attach_product_to_actor_with_http_info(product_id, actor_id, **kwargs)
        else:
            (data) = self.attach_product_to_actor_with_http_info(product_id, actor_id, **kwargs)
            return data

    def attach_product_to_actor_with_http_info(self, product_id, actor_id, **kwargs):
        """
        Attach product to actor
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_actor_with_http_info(product_id, actor_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method attach_product_to_actor" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `attach_product_to_actor`")
        # verify the required parameter 'actor_id' is set
        if ('actor_id' not in params) or (params['actor_id'] is None):
            raise ValueError("Missing the required parameter `actor_id` when calling `attach_product_to_actor`")
    ...
    def attach_product_to_director(self, product_id, director_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_director(product_id, director_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.attach_product_to_director_with_http_info(product_id, director_id, **kwargs)
        else:
            (data) = self.attach_product_to_director_with_http_info(product_id, director_id, **kwargs)
            return data

    def attach_product_to_director_with_http_info(self, product_id, director_id, **kwargs):
        """
        Attach product to director
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_director_with_http_info(product_id, director_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method attach_product_to_director" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `attach_product_to_director`")
        # verify the required parameter 'director_id' is set
        if ('director_id' not in params) or (params['director_id'] is None):
            raise ValueError("Missing the required parameter `director_id` when calling `attach_product_to_director`")
    ...
    def attach_product_to_group(self, product_id, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_group(product_id, group_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.attach_product_to_group_with_http_info(product_id, group_id, **kwargs)
        else:
            (data) = self.attach_product_to_group_with_http_info(product_id, group_id, **kwargs)
            return data

    def attach_product_to_group_with_http_info(self, product_id, group_id, **kwargs):
        """
        Attach product to group
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_group_with_http_info(product_id, group_id, callback=callback_function)
        ...
        all_params = ['product_id', 'group_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method attach_product_to_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `attach_product_to_group`")
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `attach_product_to_group`")
    ...
    def detach_product_from_group(self, product_id, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_group(product_id, group_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.detach_product_from_group_with_http_info(product_id, group_id, **kwargs)
        else:
            (data) = self.detach_product_from_group_with_http_info(product_id, group_id, **kwargs)
            return data

    def detach_product_from_group_with_http_info(self, product_id, group_id, **kwargs):
        """
        Detach product from group
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.detach_product_from_group_with_http_info(product_id, group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method detach_product_from_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `detach_product_from_group`")
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `detach_product_from_group`")


        collection_formats = {}

        resource_path = '/products/{product_id}/groups/{group_id}'.replace('{format}', 'json')
        path_params = {}
        if 'product_id' in params:
            path_params['product_id'] = params['product_id']
        if 'group_id' in params:
    ...
    def get_best_sales(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_best_sales(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_best_sales_with_http_info(**kwargs)
        else:
            (data) = self.get_best_sales_with_http_info(**kwargs)
            return data

    def get_best_sales_with_http_info(self, **kwargs):
        """
        Get most saled Products
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_best_sales_with_http_info(callback=callback_function)
        ...
        all_params = ['page', 'per_page', 'ip', 'iso_code']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        resource_path = '/products/best-sales'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_most_watched(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_most_watched(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_most_watched_with_http_info(**kwargs)
        else:
            (data) = self.get_most_watched_with_http_info(**kwargs)
            return data

    def get_most_watched_with_http_info(self, **kwargs):
        """
        Get most watched products list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_most_watched_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_most_watched" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/products/most-watched'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_new_products(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_new_products(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_new_products_with_http_info(**kwargs)
        else:
            (data) = self.get_new_products_with_http_info(**kwargs)
            return data

    def get_new_products_with_http_info(self, **kwargs):
        """
        Get new products list
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_new_products_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_new_products" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/products/new'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_price(self, body, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ProductIDList1 body: List of Product IDs separated by comma, eg. '42,21,84' (required)
    ...
    def get_price_with_http_info(self, body, **kwargs):
        ...
        resource_path = '/products/price'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[ProductPrice]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_product_extracts_with_http_info(self, product_id, **kwargs):
        ...
        all_params = ['product_id', 'ip', 'page', 'per_page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_products(self, **kwargs):
        ...
        :param int page:
        :param int per_page:
        :param str features:      ```     featureId[value]=string&featureId[operator]=strict     _______________      {     \"*\": {     \"value\": \"string\",     \"operator\": \"strict\"     },     \"1\": {     \"value\": \"string\",     \"operator\": \"contains\"     }     } ```     Operator can be: strict, contains, between, in, gt (greater than), lt (lower than).     To search on all features, you can pass * as featureId.
        :param str filters:      ```     name[value]=string&name[operator]=contains&date_add[value]=string&date_add[operator]=lt     _______________      {     \"name\": {     \"value\": \"string\",     \"operator\": \"contains\"     },     \"date_add\": {     \"value\": \"string\",     \"operator\": \"lt\"     }     } ```     Operator can be: strict, contains, between, in, gt (greater than), lt (lower than).
        :param str sort_by: Sort by this attribute (id by default)
        :param str sort_direction: Sorting direction (asc by default)
        :param str ip: Filter by user IP
    ...
    def get_products_with_http_info(self, **kwargs):
        ...
        all_params = ['page', 'per_page', 'features', 'filters', 'sort_by', 'sort_direction', 'ip', 'customer_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_product_group_restriction_behavior(self, product_id, behavior, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_product_group_restriction_behavior(product_id, behavior, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_product_group_restriction_behavior_with_http_info(product_id, behavior, **kwargs)
        else:
            (data) = self.update_product_group_restriction_behavior_with_http_info(product_id, behavior, **kwargs)
            return data

    def update_product_group_restriction_behavior_with_http_info(self, product_id, behavior, **kwargs):
        """
        Update product group restriction behavior
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_product_group_restriction_behavior_with_http_info(product_id, behavior, callback=callback_function)
        ...
        all_params = ['product_id', 'behavior']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_product_group_restriction_behavior" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `update_product_group_restriction_behavior`")
        # verify the required parameter 'behavior' is set
        if ('behavior' not in params) or (params['behavior'] is None):
            raise ValueError("Missing the required parameter `behavior` when calling `update_product_group_restriction_behavior`")


        collection_formats = {}

        resource_path = '/products/{product_id}/groups/behavior'.replace('{format}', 'json')
        path_params = {}
        if 'product_id' in params:
            path_params['product_id'] = params['product_id']
        ...
        if 'behavior' in params:
            query_params['behavior'] = params['behavior']
