...
class ImagesApi(object):
    ...
    def upload_actor_cover(self, body, **kwargs):
        """
        Upload actor cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_actor_cover(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UploadActorCoverRequest body: (required)
        :return: ImageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_actor_cover_with_http_info(body, **kwargs)
        else:
            (data) = self.upload_actor_cover_with_http_info(body, **kwargs)
            return data

    def upload_actor_cover_with_http_info(self, body, **kwargs):
        """
        Upload actor cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_actor_cover_with_http_info(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_actor_cover`")
    ...
    def upload_director_cover(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_director_cover(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param UploadDirectorCoverRequest body: (required)
        :return: Image
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_director_cover_with_http_info(body, **kwargs)
        else:
            (data) = self.upload_director_cover_with_http_info(body, **kwargs)
            return data

    def upload_director_cover_with_http_info(self, body, **kwargs):
        """
        Upload director cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_director_cover_with_http_info(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `upload_director_cover`")
