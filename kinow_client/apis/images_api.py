...
class ImagesApi(object):
    ...
    def delete_product_screenshot(self, product_id, image_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_product_screenshot(product_id, image_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param float product_id: Product ID to fetch (required)
        :param float image_id: Image ID to delete (required)
        :return: None
        ...
        if kwargs.get('callback'):
            return self.delete_product_screenshot_with_http_info(product_id, image_id, **kwargs)
        else:
            (data) = self.delete_product_screenshot_with_http_info(product_id, image_id, **kwargs)
            return data

    def delete_product_screenshot_with_http_info(self, product_id, image_id, **kwargs):
        """
        Delete product screenshot
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_product_screenshot_with_http_info(product_id, image_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_product_screenshot" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `delete_product_screenshot`")
        # verify the required parameter 'image_id' is set
        if ('image_id' not in params) or (params['image_id'] is None):
            raise ValueError("Missing the required parameter `image_id` when calling `delete_product_screenshot`")
    ...
    def upload_product_screenshot(self, product_id, image_id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param float product_id: Product ID to fetch (required)
        :param float image_id: Image ID to fetch (required)
