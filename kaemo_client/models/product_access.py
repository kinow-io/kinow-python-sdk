...
class ProductAccess(object):
    ...
    """
    def __init__(self, id=None, id_customer=None, id_product=None, id_product_attribute=None, type=None, date_add=None, date_exp=None, cancel=None, recurring=None, active=None, message=None):
        """
