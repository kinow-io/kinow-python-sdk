...
class ProductAccess(object):
    ...
    """
    def __init__(self, id=None, id_shop=None, id_customer=None, id_product=None, id_product_attribute=None, type=None, date_add=None, date_exp=None, cancel=None, recurring=None, active=None, message=None):
        """
    ...
    def id_shop(self):
        """
        Gets the id_shop of this ProductAccess.

        :return: The id_shop of this ProductAccess.
        :rtype: int
        """
    ...
    def id_shop(self, id_shop):
        """
        Sets the id_shop of this ProductAccess.

        :param id_shop: The id_shop of this ProductAccess.
        :type: int
        """
