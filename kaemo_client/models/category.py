...
class Category(object):
    ...
    """
    def __init__(self, id=None, id_parent=None, date_add=None, date_upd=None, active=None, position=None, meta_description=None, meta_keywords=None, meta_title=None, link_rewrite=None, name=None, description=None, description_short=None):
        """
