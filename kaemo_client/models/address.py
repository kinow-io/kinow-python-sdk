...
class Address(object):
    ...
    """
    def __init__(self, id=None, id_customer=None, id_country=None, id_state=None, company=None, vat_number=None, address1=None, postcode=None, city=None, date_add=None, date_upd=None):
        """
