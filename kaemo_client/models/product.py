...
class Product(object):
    ...
    """
    def __init__(self, id=None, reference=None, date_from=None, date_to=None, price=None, position=None, active=None, available_for_order=None, date_add=None, date_upd=None, id_category_default=None, images=None, attributes=None, meta_description=None, meta_keywords=None, meta_title=None, link_rewrite=None, name=None, description=None, description_short=None, tags=None, can_buy=None, available_in_subscriptions=None, duration=None, sub=None, has_group_restriction=None, geoloc_enabled=None, behavior_detected_countries=None, behavior_non_detected_countries=None):
        """
