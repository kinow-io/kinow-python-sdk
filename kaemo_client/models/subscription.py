...
class Subscription(object):
    ...
    """
    def __init__(self, id=None, duration=None, trial_duration=None, trial_percent=None, trial_sub=None, limit=None, limit_duration=None, alert_type=None, alert_qty=None, active=None):
        """
