...
class Extract(object):
    ...
    """
    def __init__(self, id=None, id_shop=None, id_product=None, id_product_image=None, id_media_player=None, id_media_source=None, filename=None, position=None, active=None, date_add=None, date_upd=None, name=None, description=None):
        """
    ...
    def id_shop(self):
        """
        Gets the id_shop of this Extract.

        :return: The id_shop of this Extract.
        :rtype: int
        """
    ...
    def id_shop(self, id_shop):
        """
        Sets the id_shop of this Extract.

        :param id_shop: The id_shop of this Extract.
        :type: int
        """
