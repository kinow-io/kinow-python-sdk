...
class Customer(object):
    ...
    """
    def __init__(self, id=None, lastname=None, firstname=None, email=None, id_gender=None, birthday=None, newsletter=None, optin=None, active=None, id_lang=None, date_add=None, date_upd=None, max_viewing=None, custom=None, password=None, id_country=None):
        """
