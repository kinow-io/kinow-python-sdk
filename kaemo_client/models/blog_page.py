...
class BlogPage(object):
    ...
    """
    def __init__(self, id_lang=None, title=None, link_rewrite=None, description_short=None, description=None, meta_title=None, meta_description=None, meta_keywords=None, date_add=None, date_issue=None, date_upd=None, active=None, id_blog_category=None, cover=None):
        """
