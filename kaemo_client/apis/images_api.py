...
class ImagesApi(object):
    ...
    def get_video_cover(self, **kwargs):
        """
        Get video cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_video_cover(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_video_cover_with_http_info(**kwargs)
        else:
            (data) = self.get_video_cover_with_http_info(**kwargs)
            return data

    def get_video_cover_with_http_info(self, **kwargs):
        """
        Get video cover
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_video_cover_with_http_info(callback=callback_function)
