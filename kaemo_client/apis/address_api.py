...
class AddressApi(object):
    ...
    def update_address(self, body, **kwargs):
        """
        Update address
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_address(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param Address body: Update address (required)
        :return: Address
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_address_with_http_info(body, **kwargs)
        else:
            (data) = self.update_address_with_http_info(body, **kwargs)
            return data

    def update_address_with_http_info(self, body, **kwargs):
        """
        Update address
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_address_with_http_info(body, callback=callback_function)
