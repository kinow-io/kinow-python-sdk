...
class ProductsApi(object):
    ...
    def attach_product_to_director_0(self, product_id, group_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_director_0(product_id, group_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.attach_product_to_director_0_with_http_info(product_id, group_id, **kwargs)
        else:
            (data) = self.attach_product_to_director_0_with_http_info(product_id, group_id, **kwargs)
            return data

    def attach_product_to_director_0_with_http_info(self, product_id, group_id, **kwargs):
        """
        Attach product to group
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.attach_product_to_director_0_with_http_info(product_id, group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method attach_product_to_director_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'product_id' is set
        if ('product_id' not in params) or (params['product_id'] is None):
            raise ValueError("Missing the required parameter `product_id` when calling `attach_product_to_director_0`")
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `attach_product_to_director_0`")
