...
class TestImagesApi(unittest.TestCase):
    ...
    def test_get_category_image_types(self):
        """
        Test case for get_category_image_types
    ...
    def test_get_product_image_types(self):
        """
        Test case for get_product_image_types
