...
class TestPrepaymentsApi(unittest.TestCase):
    ...
    def test_get_prepayment_bonus_amount(self):
        """
        Test case for get_prepayment_bonus_amount
    ...
    def test_get_prepayment_operations_amount(self):
        """
        Test case for get_prepayment_operations_amount
