...
> Products get_blog_page_products(blog_page_id, page=page, per_page=per_page)
...
try: 
    api_response = api_instance.get_blog_page_products(blog_page_id, page=page, per_page=per_page)
    pprint(api_response)
except ApiException as e:
