...
## **get_video_group**
> VideoGroupResponse get_video_group(video_group_id)
...
## **get_video_groups**
> VideoGroupListResponse get_video_groups(page=page, per_page=per_page, filters=filters, sort_by=sort_by, sort_direction=sort_direction)
