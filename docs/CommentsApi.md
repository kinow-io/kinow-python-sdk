...
[**get_comment**](#get_comment) | **GET** /comments/{comment_id} | 
[**get_comments**](#get_comments) | **GET** /comments | 
...
try: 
    api_response = api_instance.get_comments(page=page, per_page=per_page, filters=filters, sort_by=sort_by, sort_direction=sort_direction)
    pprint(api_response)
except ApiException as e:
