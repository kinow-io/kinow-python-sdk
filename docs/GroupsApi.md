...
[**get_group_customers**](#get_group_customers) | **GET** /groups/{group_id}/customers | 
...
## **create_group**
> GroupResponse create_group(body)
...
# create an instance of the API class
api_instance = kinow_client.GroupsApi()
body = kinow_client.CreateGroupRequest() # CreateGroupRequest | Group settings
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**CreateGroupRequest**](#CreateGroupRequest)| Group settings | 
...
## **get_group**
> GroupResponse get_group(group_id)
...
## **get_group_customers**
> CustomerListResponse get_group_customers(group_id, page=page, per_page=per_page, filters=filters, sort_by=sort_by, sort_direction=sort_direction)
...
try: 
    api_response = api_instance.get_group_customers(group_id, page=page, per_page=per_page, filters=filters, sort_by=sort_by, sort_direction=sort_direction)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling GroupsApi->get_group_customers: %s\n" % e)
```
...
## **get_groups**
> GroupListResponse get_groups(page=page, per_page=per_page, filters=filters, sort_by=sort_by, sort_direction=sort_direction)
